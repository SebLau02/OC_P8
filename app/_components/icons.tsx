...
const MaltIcon = ({ className }: Icons) => {
  return (
    <svg
      aria-label="Malt"
      role="img"
...
const GithubIcon = ({ className }: Icons) => {
  return (
    <svg
      className={`${className} w-4 ml-2`}
      viewBox="0 0 20 20"
...
const InstaIcon = ({ className }: Icons) => {
  return (
    <svg
      className={`${className} w-4 ml-2`}
      viewBox="0 0 448 512"
...
const LinkedinIcon = ({ className }: Icons) => {
  return (
    <svg
      className={`${className} w-4 ml-2`}
      viewBox="0 0 448 512"
...
const ContactIcon = ({ className }: Icons) => {
  return (
    <svg
      className={`${className} w-4 ml-2`}
      viewBox="0 0 512 512"
...
export const ArrowIcons = () => {
  return (
    <svg fill="hsl(60 30% 96%)" viewBox="0 0 448 512">
      <path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
    </svg>
  );
};

export { ContactIcon, GithubIcon, MaltIcon, InstaIcon, LinkedinIcon };
